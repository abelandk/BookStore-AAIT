...
<html>
  ...
  <body>
         ...
         <div class="body3 tablist">
             <!--<form class="well">-->
                <form class="well text-center text-warrning" action='<?php echo base_url('index.php/')."/login_controller/insert_department2"?>' method="post">
...
<!--             </form>
     ...
     <form class="well text-center text-warrning" action='<?php echo base_url('index.php/')."/login_controller/insert_department2"?>' method="post">-->
         <input type="text" class="span3 text-center" required placeholder="Enter New Department Id" name="id"/>
         <input type="text" class="span3 text-center" required placeholder="Enter New Department Name" name="dep_name"/>
