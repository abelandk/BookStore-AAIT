...
<!--          </form>-->
             <div class="body4 c7">
                 <form action="<?php echo base_url('index.php');?>/login_controller/with_Db_1" method="POST" class="text-center span5">
              <label>With</label>
              <input name="Id_1" type="text" class="span3 text-center"  value="<?php echo $Id ;?>"/>
      ...
      <label>Id</label>
            <input name="Id_2" type="text" class="span3 text-center"  placeholder="Enter Id"/>
