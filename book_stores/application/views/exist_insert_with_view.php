...
<html>
  ...
  <body>
         ...
         <div class="body3 tablist">
             ...
             <div class="body4 c7">
                 <form action="<?php echo base_url('index.php');?>/login_controller/exist_insert_Db2" method="POST" class="text-center span5">
        <label>With</label>
      ...
      <label>Id</label>
            <input name="Id" type="text" class="span3 text-center"  placeholder="Enter Id"/></br>
