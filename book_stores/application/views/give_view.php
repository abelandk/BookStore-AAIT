...
<html>
  ...
  <body>
         ...
         <div class="body3 tablist">
             ...
             <div class="body4 c7">
                 <form action="<?php echo base_url('index.php');?>/home_controller/Give_Db" method="POST" class="text-center span5">
       
      <label>Name/To</label>
            <input name="Holder" type="text" class="span3 text-center"  placeholder="Name of the property"/>
     ...
     <select class="text-center" name="Type"> 
      ...
      <label>Status</label>
            <input name="Status" type="text" class="span3 text-center"  placeholder="Status"/>
     </br>
      
      <input type="submit" name="Save" class="btn btn-primary" value="Give">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
