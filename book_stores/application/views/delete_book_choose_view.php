...
<!--             </form>
     ...
     <form class="well text-center text-warrning" action='<?php echo base_url('index.php/')."/login_controller/delete_book2"?>' method="post">-->
                    <a class="body3 btn" href="<?php echo base_url('index.php/')."/login_controller/delete_book"?>">Delete All Book By Book Name</a></br></br>
       <a class="body3 btn" href="<?php echo base_url('index.php/')."/login_controller/delete_book_1"?>">Delete a Single Book By Book Code</a></br>
