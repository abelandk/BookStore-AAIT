...
<!--          </form>-->
             <div class="body4 c7">
                 <form action="<?php echo base_url('index.php');?>/login_controller/with_Db_2" method="POST" class="text-center span5">
             <label>With</label>
              <input name="Id_1" type="text" class="span3 text-center"  value="<?php echo $Id_1;?>"/>
               <label>With</label>
              <input name="Id_2" type="text" class="span3 text-center"  value="<?php echo $Id_2;?>"/>
              <label>Book Code</label>
              <input name="Book_Code" type="text" class="span3 text-center"  value="<?php echo $Book_Code ;?>"/>
              <label>Book Name</label>
              <input name="Book_Name" type="text" class="span3 text-center"  value="<?php echo $Book_Name ;?>"/>
             
      <label>Id</label>
            <input name="Id_3" type="text" class="span3 text-center"  placeholder="Enter Id"/>
